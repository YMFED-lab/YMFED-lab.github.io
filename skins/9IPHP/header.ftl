...
<header>
    <div class="banner">
        <div class="fn-clear wrapper">
            <a href="${servePath}" class="logo" rel="start"></a>
            <h2 class="subtitle-wrap">
                <p class="subtitle">${blogTitle}</p>
                <p class="description">${blogSubtitle}</p>
            </h2>
            <#--<h1 class="fn-inline">-->
    ...
    <div class="navbar">
        <div class="fn-clear wrapper">
            <nav class="fn-left">
                ...
                <a rel="archive" href="${servePath}/team.html">
                    <i class="icon-category"></i> 团队介绍
                </a>
                <a rel="archive" href="${servePath}/join.html">
