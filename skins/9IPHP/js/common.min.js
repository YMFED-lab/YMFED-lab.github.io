!function (e) {
    ...
    !function (t, n) {
        ...
        "use strict";
        var i = [], a = n.document, s = Object.getPrototypeOf, c = i.slice, l = i.concat, u = i.push, f = i.indexOf,
        ...
        C.fn = C.prototype = {
            ...
            for ("boolean" == typeof a && (l = a, a = arguments[s] || {}, s++), "object" == typeof a || y(a) || (a = {}), s === c && (a = this, s--); s < c; s++) if (null != (e = arguments[s])) for (t in e) r = e[t], "__proto__" !== t && a !== r && (l && r && (C.isPlainObject(r) || (o = Array.isArray(r))) ? (n = a[t], i = o && !Array.isArray(n) ? [] : o || C.isPlainObject(n) ? n : {}, o = !1, a[t] = C.extend(l, i, r)) : void 0 !== r && (a[t] = r));
            return a
        }, C.extend({
        ...
        var E = function (e) {
            var t, n, r, o, i, a, s, c, l, u, f, d, p, h, m, g, v, y, b, x = "sizzle" + 1 * new Date, w = e.document,
                T = 0, C = 0, k = ce(), S = ce(), E = ce(), j = ce(), A = function (e, t) {
                    return e === t && (f = !0), 0
                }, N = {}.hasOwnProperty, D = [], _ = D.pop, L = D.push, O = D.push, q = D.slice, I = function (e, t) {
                ...
                R = "\\[" + P + "*(" + M + ")(?:" + P + "*([*^$|!~]?=)" + P + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + M + "))|)" + P + "*\\]",
                B = ":(" + M + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + R + ")*)|.*)\\)|)",
                $ = new RegExp(P + "+", "g"), F = new RegExp("^" + P + "+|((?:^|[^\\\\])(?:\\\\.)*)" + P + "+$", "g"),
                W = new RegExp("^" + P + "*," + P + "*"), U = new RegExp("^" + P + "*([>+~]|" + P + ")" + P + "*"),
                z = new RegExp(P + "|>"), V = new RegExp(B), X = new RegExp("^" + M + "$"), J = {
                    ID: new RegExp("^#(" + M + ")"),
                    CLASS: new RegExp("^\\.(" + M + ")"),
                    TAG: new RegExp("^(" + M + "|[*])"),
                    ATTR: new RegExp("^" + R),
                ...
                }, G = /HTML$/i, Y = /^(?:input|select|textarea|button)$/i, Q = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/,
                Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/,
            ...
            try {
                O.apply(D = q.call(w.childNodes), w.childNodes), D[w.childNodes.length].nodeType
            } catch (e) {
                O = {
            ...
            function se(e, t, r, o) {
                var i, s, l, u, f, h, v, y = t && t.ownerDocument, T = t ? t.nodeType : 9;
                ...
                if (!o && ((t ? t.ownerDocument || t : w) !== p && d(t), t = t || p, m)) {
                    ...
                    if (n.qsa && !j[e + " "] && (!g || !g.test(e)) && (1 !== T || "object" !== t.nodeName.toLowerCase())) {
                        if (v = e, y = t, 1 === T && z.test(e)) {
                            for ((u = t.getAttribute("id")) ? u = u.replace(re, oe) : t.setAttribute("id", u = x), s = (h = a(e)).length; s--;) h[s] = "#" + u + " " + be(h[s]);
            ...
            for (t in n = se.support = {}, i = se.isXML = function (e) {
                ...
                return a !== p && 9 === a.nodeType && a.documentElement ? (h = (p = a).documentElement, m = !i(p), w !== p && (o = p.defaultView) && o.top !== o && (o.addEventListener ? o.addEventListener("unload", ie, !1) : o.attachEvent && o.attachEvent("onunload", ie)), n.attributes = ue((function (e) {
                ...
                if ((e.ownerDocument || e) !== p && d(e), n.matchesSelector && m && !j[t + " "] && (!v || !v.test(t)) && (!g || !g.test(t))) try {
                    var r = y.call(e, t);
                ...
                filter: {
                    TAG: function (e) {
                        ...
                        return 1 === r && 0 === o ? function (e) {
                            ...
                            var l, u, f, d, p, h, m = i !== a ? "nextSibling" : "previousSibling", g = t.parentNode,
                            ...
                            if (g) {
                                ...
                                if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                    for (b = (p = (l = (u = (f = (d = g)[x] || (d[x] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === T && l[1]) && l[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (b = p = 0) || h.pop();) if (1 === d.nodeType && ++b && d === t) {
                                        u[e] = [T, p, b];
                                        break
                                    }
                                } else if (y && (b = p = (l = (u = (f = (d = t)[x] || (d[x] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === T && l[1]), !1 === b) for (; (d = ++p && d && d[m] || (b = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (y && ((u = (f = d[x] || (d[x] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [T, b]), d !== t));) ;
            ...
            function xe(e, t, n) {
                ...
                return t.first ? function (t, n, o) {
                    ...
                    if (c) {
                        ...
                        if ((l = u[i]) && l[0] === T && l[1] === s) return d[2] = l[2];
            ...
            function Ce(e, t, n, r, o, i) {
                return r && !r[x] && (r = Ce(r)), o && !o[x] && (o = Ce(o, i)), le((function (i, a, s, c) {
                    var l, u, f, d = [], p = [], h = a.length, m = i || function (e, t, n) {
                            for (var r = 0, o = t.length; r < o; r++) se(e, t[r], n);
                            return n
                        }(t || "*", s.nodeType ? [s] : s, []), g = !e || !i && t ? m : Te(m, d, e, s, c),
                        v = n ? o || (i ? e : h || r) ? [] : a : g;
                    if (n && n(g, v, s, c), r) for (l = Te(v, p), r(l, [], s, c), u = l.length; u--;) (f = l[u]) && (v[p[u]] = !(g[p[u]] = f));
                    if (i) {
                        if (o || e) {
                            if (o) {
                            ...
                            for (u = v.length; u--;) (f = v[u]) && (l = o ? I(i, f) : d[u]) > -1 && (i[l] = !(a[l] = f))
                        }
            ...
            function ke(e) {
                for (var t, n, o, i = e.length, a = r.relative[e[0].type], s = a || r.relative[" "], c = a ? 1 : 0, u = xe((function (e) {
                    ...
                    return t = null, o
                }]; c < i; c++) if (n = r.relative[e[c].type]) d = [xe(we(d), n)]; else {
                    if ((n = r.filter[e[c].type].apply(null, e[c].matches))[x]) {
                        for (o = ++c; o < i && !r.relative[e[o].type]; o++) ;
                        return Ce(c > 1 && we(d), c > 1 && be(e.slice(0, c - 1).concat({value: " " === e[c - 2].type ? "*" : ""})).replace(F, "$1"), n, c < o && ke(e.slice(c, o)), o < i && ke(e = e.slice(o)), o < i && be(e))
                    }
                    d.push(n)
                }
                return we(d)
            ...
            return ye.prototype = r.filters = r.pseudos, r.setFilters = new ye, a = se.tokenize = function (e, t) {
                ...
                for (s = e, c = [], l = r.preFilter; s;) {
                    for (a in n && !(o = W.exec(s)) || (o && (s = s.slice(o[0].length) || s), c.push(i = [])), n = !1, (o = U.exec(s)) && (n = o.shift(), i.push({
                        value: n,
                        type: o[0].replace(F, " ")
                    }), s = s.slice(n.length)), r.filter) !(o = J[a].exec(s)) || l[a] && !(o = l[a](o)) || (n = o.shift(), i.push({
                        value: n,
                        type: a,
                        matches: o
                    }), s = s.slice(n.length));
                ...
                if (!s) {
                    ...
                    (s = E(e, function (e, t) {
                        var n = t.length > 0, o = e.length > 0, i = function (i, a, s, c, u) {
                            var f, h, g, v = 0, y = "0", b = i && [], x = [], w = l, C = i || o && r.find.TAG("*", u),
                                k = T += null == w ? 1 : Math.random() || .1, S = C.length;
                            for (u && (l = a === p || a || u); y !== S && null != (f = C[y]); y++) {
                                if (o && f) {
                            ...
                            if (v += y, n && y !== v) {
                                ...
                                if (i) {
                                    if (v > 0) for (; y--;) b[y] || x[y] || (x[y] = _.call(c));
                                    x = Te(x)
                                }
                ...
                var i, c, l, u, f, d = "function" == typeof e && e, p = !o && a(e = d.selector || e);
                if (n = n || [], 1 === p.length) {
                    ...
                    for (i = J.needsContext.test(e) ? 0 : c.length; i-- && (l = c[i], !r.relative[u = l.type]);) if ((f = r.find[u]) && (o = f(l.matches[0].replace(te, ne), ee.test(c[0].type) && ve(t.parentNode) || t))) {
        ...
        (C.fn.init = function (e, t, n) {
            ...
            if (n = n || O, "string" == typeof e) {
                ...
                if (r[1]) {
                    if (t = t instanceof C ? t[0] : t, C.merge(this, C.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : a, !0)), _.test(r[1]) && C.isPlainObject(t)) for (r in t) y(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                    return this
                }
        ...
        var I = /^(?:parents|prev(?:Until|All))/, H = {children: !0, contents: !0, next: !0, prev: !0};
        ...
        C.fn.extend({
            ...
            C.fn[e] = function (n, r) {
                ...
                return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (o = C.filter(r, o)), this.length > 1 && (H[e] || C.uniqueSort(o), I.test(e) && o.reverse()), this.pushStack(o)
            }
        }));
        var M = /[^\x20\t\r\n\f]+/g;
        ...
        C.Callbacks = function (e) {
            ...
            Deferred: function (e) {
                var t = [["notify", "progress", C.Callbacks("memory"), C.Callbacks("memory"), 2], ["resolve", "done", C.Callbacks("once memory"), C.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", C.Callbacks("once memory"), C.Callbacks("once memory"), 1, "rejected"]],
                    r = "pending", o = {
                        state: function () {
                                ...
                                return function () {
                                    var s = this, c = arguments, l = function () {
                                        ...
                                        if (!(e < i)) {
                                            ...
                                            l = n && ("object" == typeof n || "function" == typeof n) && n.then, y(l) ? o ? l.call(n, a(i, t, R, o), a(i, t, B, o)) : (i++, l.call(n, a(i, t, R, o), a(i, t, B, o), a(i, t, R, t.notifyWith))) : (r !== R && (s = void 0, c = [n]), (o || t.resolveWith)(s, c))
                                        }
                                    }, u = o ? l : function () {
                                        try {
                                            l()
                                        } catch (n) {
                                            C.Deferred.exceptionHook && C.Deferred.exceptionHook(n, u.stackTrace), e + 1 >= i && (r !== B && (s = void 0, c = [n]), t.rejectWith(s, c))
                                        }
                                    };
                            ...
                            return C.Deferred((function (n) {
                                t[0][3].add(a(0, n, y(o) ? o : R, n.notifyWith)), t[1][3].add(a(0, n, y(e) ? e : R)), t[2][3].add(a(0, n, y(r) ? r : B))
                            })).promise()
                        }, promise: function (e) {
                ...
                var t = arguments.length, n = t, r = Array(n), o = c.call(arguments), i = C.Deferred(),
                    a = function (e) {
                        return function (n) {
        ...
        var z = function (e, t, n, r, o, i, a) {
            ...
            if ("object" === T(n)) for (s in o = !0, n) z(e, t, s, n[s], !0, i, a); else if (void 0 !== r && (o = !0, y(r) || (a = !0), l && (a ? (t.call(e, r), t = null) : (l = t, t = function (e, t, n) {
                    return l.call(C(e), n)
        ...
        function fe(e, t, n, r) {
            var o, i, a = 20, s = r ? function () {
                    ...
                    return C.css(e, t, "")
                }, c = s(), l = n && n[3] || (C.cssNumber[t] ? "" : "px"),
                u = e.nodeType && (C.cssNumber[t] || "px" !== l && +c) && oe.exec(C.css(e, t));
            if (u && u[3] !== l) {
        ...
        function ke(e, t, n, r, o) {
            for (var i, a, s, c, l, u, f = t.createDocumentFragment(), d = [], p = 0, h = e.length; p < h; p++) if ((i = e[p]) || 0 === i) if ("object" === T(i)) C.merge(d, i.nodeType ? [i] : i); else if (Ce.test(i)) {
                for (a = a || f.appendChild(t.createElement("div")), s = (ge.exec(i) || ["", ""])[1].toLowerCase(), c = ye[s] || ye._default, a.innerHTML = c[1] + C.htmlPrefilter(i) + c[2], u = c[0]; u--;) a = a.lastChild;
                C.merge(d, a.childNodes), (a = f.firstChild).textContent = ""
            } else d.push(t.createTextNode(i));
            for (f.textContent = "", p = 0; i = d[p++];) if (r && C.inArray(i, r) > -1) o && o.push(i); else if (l = se(i), a = be(f.appendChild(i), "script"), l && xe(a), n) for (u = 0; i = a[u++];) ve.test(i.type || "") && n.push(i);
            return f
        }
        ...
        var Se = /^key/, Ee = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, je = /^([^.]*)(?:\.(.+)|)/;
        ...
        function _e(e, t, n, r, o, i) {
            ...
            if (null == r && null == o ? (o = n, r = n = void 0) : null == o && ("string" == typeof n ? (o = r, r = void 0) : (o = r, r = n, n = void 0)), !1 === o) o = Ne; else if (!o) return e;
            ...
            n ? (K.set(e, t, !1), C.event.add(e, t, {
                namespace: !1, handler: function (e) {
                    ...
                    if (1 & e.isTrigger && this[t]) {
                        if (i.length) (C.event.special[t] || {}).delegateType && e.stopPropagation(); else if (i = c.call(arguments), K.set(this, t, i), r = n(this, t), this[t](), i !== (o = K.get(this, t)) || r ? K.set(this, t, !1) : o = {}, i !== o) return e.stopImmediatePropagation(), e.preventDefault(), o.value
        ...
        C.event = {
            global: {}, add: function (e, t, n, r, o) {
                var i, a, s, c, l, u, f, d, p, h, m, g = K.get(e);
                if (g) for (n.handler && (n = (i = n).handler, o = i.selector), o && C.find.matchesSelector(ae, o), n.guid || (n.guid = C.guid++), (c = g.events) || (c = g.events = {}), (a = g.handle) || (a = g.handle = function (t) {
                    return void 0 !== C && C.event.triggered !== t.type ? C.event.dispatch.apply(e, arguments) : void 0
                }), l = (t = (t || "").match(M) || [""]).length; l--;) p = m = (s = je.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), p && (f = C.event.special[p] || {}, p = (o ? f.delegateType : f.bindType) || p, f = C.event.special[p] || {}, u = C.extend({
                    type: p,
                    origType: m,
                    data: r,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, i), (d = c[p]) || ((d = c[p] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, r, h, a) || e.addEventListener && e.addEventListener(p, a)), f.add && (f.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), o ? d.splice(d.delegateCount++, 0, u) : d.push(u), C.event.global[p] = !0)
            }, remove: function (e, t, n, r, o) {
                var i, a, s, c, l, u, f, d, p, h, m, g = K.hasData(e) && K.get(e);
                if (g && (c = g.events)) {
                    for (l = (t = (t || "").match(M) || [""]).length; l--;) if (p = m = (s = je.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), p) {
                        for (f = C.event.special[p] || {}, d = c[p = (r ? f.delegateType : f.bindType) || p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = i = d.length; i--;) u = d[i], !o && m !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || r && r !== u.selector && ("**" !== r || !u.selector) || (d.splice(i, 1), u.selector && d.delegateCount--, f.remove && f.remove.call(e, u));
                        a && !d.length && (f.teardown && !1 !== f.teardown.call(e, h, g.handle) || C.removeEvent(e, p, g.handle), delete c[p])
                    } else for (p in c) C.event.remove(e, p + t[l], n, r, !0);
                    C.isEmptyObject(c) && K.remove(e, "handle events")
                }
            }, dispatch: function (e) {
                var t, n, r, o, i, a, s = C.event.fix(e), c = new Array(arguments.length),
                    l = (K.get(this, "events") || {})[s.type] || [], u = C.event.special[s.type] || {};
                for (c[0] = s, t = 1; t < arguments.length; t++) c[t] = arguments[t];
                if (s.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, s)) {
                    for (a = C.event.handlers.call(this, s, l), t = 0; (o = a[t++]) && !s.isPropagationStopped();) for (s.currentTarget = o.elem, n = 0; (i = o.handlers[n++]) && !s.isImmediatePropagationStopped();) s.rnamespace && !1 !== i.namespace && !s.rnamespace.test(i.namespace) || (s.handleObj = i, s.data = i.data, void 0 !== (r = ((C.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, c)) && !1 === (s.result = r) && (s.preventDefault(), s.stopPropagation()));
                ...
                load: {noBubble: !0}, click: {
                    setup: function (e) {
                        var t = this || e;
                        return me.test(t.type) && t.click && D(t, "input") && Le(t, "click", Ae), !1
                    }, trigger: function (e) {
                        var t = this || e;
        ...
        var Oe = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
            qe = /<script|<style|<link/i, Ie = /checked\s*(?:[^=]|=\s*.checked.)/i,
            He = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
        ...
        function Be(e, t) {
            var n, r, o, i, a, s, c, l;
            if (1 === t.nodeType) {
                if (K.hasData(e) && (i = K.access(e), a = K.set(t, i), l = i.events)) for (o in delete a.handle, a.events = {}, l) for (n = 0, r = l[o].length; n < r; n++) C.event.add(t, o, l[o][n]);
        ...
        function Fe(e, t, n, r) {
            t = l.apply([], t);
            var o, i, a, s, c, u, f = 0, d = e.length, p = d - 1, h = t[0], m = y(h);
            if (m || d > 1 && "string" == typeof h && !v.checkClone && Ie.test(h)) return e.each((function (o) {
                var i = e.eq(o);
                m && (t[0] = h.call(this, o, i.html())), Fe(i, t, n, r)
            }));
            if (d && (i = (o = ke(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === o.childNodes.length && (o = i), i || r)) {
                for (s = (a = C.map(be(o, "script"), Me)).length; f < d; f++) c = o, f !== p && (c = C.clone(c, !0, !0), s && C.merge(a, be(c, "script"))), n.call(e[f], c, f);
                if (s) for (u = a[a.length - 1].ownerDocument, C.map(a, Re), f = 0; f < s; f++) c = a[f], ve.test(c.type || "") && !K.access(c, "globalEval") && C.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? C._evalUrl && !c.noModule && C._evalUrl(c.src, {nonce: c.nonce || c.getAttribute("nonce")}) : w(c.textContent.replace(He, ""), c, u))
            }
            return e
        }

        function We(e, t, n) {
            for (var r, o = t ? C.filter(t, e) : e, i = 0; null != (r = o[i]); i++) n || 1 !== r.nodeType || C.cleanData(be(r)), r.parentNode && (n && se(r) && xe(be(r, "script")), r.parentNode.removeChild(r));
            return e
        }
        ...
        C.extend({
            htmlPrefilter: function (e) {
                ...
                var r, o, i, a, s = e.cloneNode(!0), c = se(e);
                if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e))) for (a = be(s), r = 0, o = (i = be(e)).length; r < o; r++) $e(i[r], a[r]);
                if (t) if (n) for (i = i || be(e), a = a || be(s), r = 0, o = i.length; r < o; r++) Be(i[r], a[r]); else Be(e, s);
            ...
            detach: function (e) {
                ...
                return z(this, (function (e) {
                    ...
                    if ("string" == typeof e && !qe.test(e) && !ye[(ge.exec(e) || ["", ""])[1].toLowerCase()]) {
                        e = C.htmlPrefilter(e);
                        try {
            ...
            C.fn[e] = function (e) {
                for (var n, r = [], o = C(e), i = o.length - 1, a = 0; a <= i; a++) n = a === i ? this : this.clone(!0), C(o[a])[t](n), u.apply(r, n.get());
        ...
        function Xe(e, t, n) {
            ...
            return (n = n || ze(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || se(e) || (a = C.style(e, t)), !v.pixelBoxStyles() && Ue.test(a) && Ve.test(t) && (r = s.width, o = s.minWidth, i = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = o, s.maxWidth = i)), void 0 !== a ? a + "" : a
        }
        ...
        !function () {
            function e() {
                if (u) {
                    ...
                    r = "1%" !== e.top, c = 12 === t(e.marginLeft), u.style.right = "60%", s = 36 === t(e.right), o = 36 === t(e.width), u.style.position = "absolute", i = 12 === t(u.offsetWidth / 3), ae.removeChild(l), u = null
                }
            }
            ...
            var r, o, i, s, c, l = a.createElement("div"), u = a.createElement("div");
        ...
        var Ge = ["Webkit", "Moz", "ms"], Ye = a.createElement("div").style, Qe = {};
        ...
        function it(e, t, n) {
            var r = ze(e), o = (!v.boxSizingReliable() || n) && "border-box" === C.css(e, "boxSizing", !1, r), i = o,
                a = Xe(e, t, r), s = "offset" + t[0].toUpperCase() + t.slice(1);
            if (Ue.test(a)) {
                if (!n) return a;
                a = "auto"
            }
            return (!v.boxSizingReliable() && o || "auto" === a || !parseFloat(a) && "inline" === C.css(e, "display", !1, r)) && e.getClientRects().length && (o = "border-box" === C.css(e, "boxSizing", !1, r), (i = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + ot(e, t, n || (o ? "border" : "content"), i, r, a) + "px"
        }
        ...
        C.extend({
            ...
            style: function (e, t, n, r) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    var o, i, a, s = G(t), c = et.test(t), l = e.style;
                    if (c || (t = Ke(s)), a = C.cssHooks[t] || C.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (o = a.get(e, !1, r)) ? o : l[t];
                    "string" === (i = typeof n) && (o = oe.exec(n)) && o[1] && (n = fe(e, t, o), i = "number"), null != n && n == n && ("number" !== i || c || (n += o && o[3] || (C.cssNumber[s] ? "" : "px")), v.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (c ? l.setProperty(t, n) : l[t] = n))
                }
            },
            css: function (e, t, n, r) {
                var o, i, a, s = G(t);
                return et.test(t) || (t = Ke(s)), (a = C.cssHooks[t] || C.cssHooks[s]) && "get" in a && (o = a.get(e, !0, n)), void 0 === o && (o = Xe(e, t, r)), "normal" === o && t in nt && (o = nt[t]), "" === n || n ? (i = parseFloat(o), !0 === n || isFinite(i) ? i || 0 : o) : o
            }
        }), C.each(["height", "width"], (function (e, t) {
            C.cssHooks[t] = {
                get: function (e, n, r) {
                    if (n) return !Ze.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? it(e, t, r) : ue(e, tt, (function () {
                        return it(e, t, r)
                    }))
                }, set: function (e, n, r) {
                    var o, i = ze(e), a = !v.scrollboxSize() && "absolute" === i.position,
                        s = (a || r) && "border-box" === C.css(e, "boxSizing", !1, i), c = r ? ot(e, t, r, s, i) : 0;
        ...
        })), C.cssHooks.marginLeft = Je(v.reliableMarginLeft, (function (e, t) {
        ...
        var st, ct, lt = /^(?:toggle|show|hide)$/, ut = /queueHooks$/;
        ...
        function mt(e, t, n) {
            ...
            }(u, l.opts.specialEasing); i < a; i++) if (r = mt.prefilters[i].call(l, e, u, l.opts)) return y(r.stop) && (C._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
            return C.map(u, ht, l), y(l.opts.start) && l.opts.start.call(e, l), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always), C.fx.timer(C.extend(c, {
                elem: e,
                anim: l,
                queue: l.opts.queue
            })), l
        ...
        C.Animation = C.extend(mt, {
            tweeners: {
                ...
                var r, o, i, a, s, c, l, u, f = "width" in t || "height" in t, d = this, p = {}, h = e.style,
                ...
                if ((c = !C.isEmptyObject(t)) || !C.isEmptyObject(p)) for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = g && g.display) && (l = K.get(e, "display")), "none" === (u = C.css(e, "display")) && (l ? u = l : (he([e], !0), l = e.style.display || l, u = C.css(e, "display"), he([e]))), ("inline" === u || "inline-block" === u && null != l) && "none" === C.css(e, "float") && (c || (d.done((function () {
                    h.display = l
                })), null == l && (u = h.display, l = "none" === u ? "" : u)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", d.always((function () {
                    h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
                }))), c = !1, p) c || (g ? "hidden" in g && (m = g.hidden) : g = K.access(e, "fxshow", {display: l}), i && (g.hidden = !m), m && he([e], !0), d.done((function () {
                    for (r in m || he([e]), K.remove(e, "fxshow"), p) C.style(e, r, p[r])
                }))), c = ht(m ? g[r] : 0, r, d), r in g || (g[r] = c.start, m && (c.end = c.start, c.start = 0))
        ...
        C.fn.extend({
            ...
            addClass: function (e) {
                ...
                if ((t = Tt(e)).length) for (; n = this[c++];) if (o = wt(n), r = 1 === n.nodeType && " " + xt(o) + " ") {
                ...
                return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : y(e) ? this.each((function (n) {
                    ...
                    var t, o, i, a;
                    if (r) for (o = 0, i = C(this), a = Tt(e); t = a[o++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else void 0 !== e && "boolean" !== n || ((t = wt(this)) && K.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : K.get(this, "__className__") || ""))
                }))
            }, hasClass: function (e) {
                var t, n, r = 0;
                ...
                option: {
                    ...
                    get: function (e) {
                        var t, n, r, o = e.options, i = e.selectedIndex, a = "select-one" === e.type, s = a ? null : [],
                            c = a ? i + 1 : o.length;
                        for (r = i < 0 ? c : a ? i : 0; r < c; r++) if (((n = o[r]).selected || r === i) && !n.disabled && (!n.parentNode.disabled || !D(n.parentNode, "optgroup"))) {
        ...
        C.extend(C.event, {
            trigger: function (e, t, r, o) {
                var i, s, c, l, u, f, d, p, m = [r || a], g = h.call(e, "type") ? e.type : e,
                    v = h.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = p = c = r = r || a, 3 !== r.nodeType && 8 !== r.nodeType && !kt.test(g + C.event.triggered) && (g.indexOf(".") > -1 && (v = g.split("."), g = v.shift(), v.sort()), u = g.indexOf(":") < 0 && "on" + g, (e = e[C.expando] ? e : new C.Event(g, "object" == typeof e && e)).isTrigger = o ? 2 : 3, e.namespace = v.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : C.makeArray(t, [e]), d = C.event.special[g] || {}, o || !d.trigger || !1 !== d.trigger.apply(r, t))) {
                    if (!o && !d.noBubble && !b(r)) {
                        for (l = d.delegateType || g, kt.test(l + g) || (s = s.parentNode); s; s = s.parentNode) m.push(s), c = s;
                        c === (r.ownerDocument || a) && m.push(c.defaultView || c.parentWindow || n)
                    }
                    for (i = 0; (s = m[i++]) && !e.isPropagationStopped();) p = s, e.type = i > 1 ? l : d.bindType || g, (f = (K.get(s, "events") || {})[e.type] && K.get(s, "handle")) && f.apply(s, t), (f = u && s[u]) && f.apply && Y(s) && (e.result = f.apply(s, t), !1 === e.result && e.preventDefault());
                    return e.type = g, o || e.isDefaultPrevented() || d._default && !1 !== d._default.apply(m.pop(), t) || !Y(r) || u && y(r[g]) && !b(r) && ((c = r[u]) && (r[u] = null), C.event.triggered = g, e.isPropagationStopped() && p.addEventListener(g, St), r[g](), e.isPropagationStopped() && p.removeEventListener(g, St), C.event.triggered = void 0, c && (r[u] = c)), e.result
                }
        ...
        var Et = n.location, jt = Date.now(), At = /\?/;
        ...
        C.param = function (e, t) {
            ...
            serialize: function () {
                ...
                return this.map((function () {
                    ...
                    var e = this.type;
                    return this.name && !C(this).is(":disabled") && Lt.test(this.nodeName) && !_t.test(e) && (this.checked || !me.test(e))
                })).map((function (e, t) {
                    var n = C(this).val();
        ...
        var qt = /%20/g, It = /#.*$/, Ht = /([?&])_=[^&]*/, Pt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Mt = /^(?:GET|HEAD)$/,
            Rt = /^\/\//, Bt = {}, $t = {}, Ft = "*/".concat("*"), Wt = a.createElement("a");
        ...
        Wt.href = Et.href, C.extend({
            ...
            ajax: function (e, t) {
                ...
                var r, o, i, s, c, l, u, f, d, p, h = C.ajaxSetup({}, t), m = h.context || h,
                    g = h.context && (m.nodeType || m.jquery) ? C(m) : C.event, v = C.Deferred(),
                    y = C.Callbacks("once memory"), b = h.statusCode || {}, x = {}, w = {}, T = "canceled", k = {
                ...
                if (v.promise(k), h.url = ((e || h.url || Et.href) + "").replace(Rt, Et.protocol + "//"), h.type = t.method || t.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(M) || [""], null == h.crossDomain) {
                    l = a.createElement("a");
                    try {
                ...
                if (h.data && h.processData && "string" != typeof h.data && (h.data = C.param(h.data, h.traditional)), zt(Bt, h, t, k), u) return k;
                for (d in(f = C.event && h.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Mt.test(h.type), o = h.url.replace(It, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(qt, "+")) : (p = h.url.slice(o.length), h.data && (h.processData || "string" == typeof h.data) && (o += (At.test(o) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (o = o.replace(Ht, "$1"), p = (At.test(o) ? "&" : "?") + "_=" + jt++ + p), h.url = o + p), h.ifModified && (C.lastModified[o] && k.setRequestHeader("If-Modified-Since", C.lastModified[o]), C.etag[o] && k.setRequestHeader("If-None-Match", C.etag[o])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && k.setRequestHeader("Content-Type", h.contentType), k.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Ft + "; q=0.01" : "") : h.accepts["*"]), h.headers) k.setRequestHeader(d, h.headers[d]);
                if (h.beforeSend && (!1 === h.beforeSend.call(m, k, h) || u)) return k.abort();
                if (T = "abort", y.add(h.complete), k.done(h.success), k.fail(h.error), r = zt($t, h, t, k)) {
                ...
                function S(e, t, a, s) {
                    var l, d, p, x, w, T = t;
                    u || (u = !0, c && n.clearTimeout(c), r = void 0, i = s || "", k.readyState = e > 0 ? 4 : 0, l = e >= 200 && e < 300 || 304 === e, a && (x = function (e, t, n) {
                        ...
                        for (i = u.shift(); i;) if (e.responseFields[i] && (n[e.responseFields[i]] = t), !c && r && e.dataFilter && (t = e.dataFilter(t, e.dataType)), c = i, i = u.shift()) if ("*" === i) i = c; else if ("*" !== c && c !== i) {
                            if (!(a = l[c + " " + i] || l["* " + i])) for (o in l) if ((s = o.split(" "))[1] === i && (a = l[c + " " + s[0]] || l["* " + s[0]])) {
                    ...
                    }(h, x, k, l), l ? (h.ifModified && ((w = k.getResponseHeader("Last-Modified")) && (C.lastModified[o] = w), (w = k.getResponseHeader("etag")) && (C.etag[o] = w)), 204 === e || "HEAD" === h.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = x.state, d = x.data, l = !(p = x.error))) : (p = T, !e && T || (T = "error", e < 0 && (e = 0))), k.status = e, k.statusText = (t || T) + "", l ? v.resolveWith(m, [d, T, k]) : v.rejectWith(m, [k, T, p]), k.statusCode(b), b = void 0, f && g.trigger(l ? "ajaxSuccess" : "ajaxError", [k, h, l ? d : p]), y.fireWith(m, [k, T]), f && (g.trigger("ajaxComplete", [k, h]), --C.active || C.event.trigger("ajaxStop")))
                }
        ...
        var Xt = {0: 200, 1223: 204}, Jt = C.ajaxSettings.xhr();
        v.cors = !!Jt && "withCredentials" in Jt, v.ajax = Jt = !!Jt, C.ajaxTransport((function (e) {
            var t, r;
        ...
        C.ajaxSetup({
            ...
            return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (v.createHTMLDocument ? ((r = (t = a.implementation.createHTMLDocument("")).createElement("base")).href = a.location.href, t.head.appendChild(r)) : t = a), i = !n && [], (o = _.exec(e)) ? [t.createElement(o[1])] : (o = ke([e], t, i), i && i.length && C(i).remove(), C.merge([], o.childNodes)));
            var r, o, i
        }, C.fn.load = function (e, t, n) {
            var r, o, i, a = this, s = e.indexOf(" ");
            return s > -1 && (r = xt(e.slice(s)), e = e.slice(0, s)), y(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), a.length > 0 && C.ajax({
                url: e,
                type: o || "GET",
                dataType: "html",
                data: t
            ...
            setOffset: function (e, t, n) {
                var r, o, i, a, s, c, l = C.css(e, "position"), u = C(e), f = {};
                "static" === l && (e.style.position = "relative"), s = u.offset(), i = C.css(e, "top"), c = C.css(e, "left"), ("absolute" === l || "fixed" === l) && (i + c).indexOf("auto") > -1 ? (a = (r = u.position()).top, o = r.left) : (a = parseFloat(i) || 0, o = parseFloat(c) || 0), y(t) && (t = t.call(e, n, C.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + o), "using" in t ? t.using.call(e, f) : u.css(f)
            }
        }, C.fn.extend({
            offset: function (e) {
            ...
            C.cssHooks[t] = Je(v.pixelPosition, (function (e, n) {
        ...
        }, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = D, C.isFunction = y, C.isWindow = b, C.camelCase = G, C.type = T, C.now = Date.now, C.isNumeric = function (e) {
            var t = C.type(e);
    ...
    void 0 === (o = "function" == typeof(r = function () {
        ...
        n.configure = function (e) {
            ...
            var c = n.render(!t), l = c.querySelector(r.barSelector), u = r.speed, f = r.easing;
            return c.offsetWidth, a((function (t) {
                ...
                }(e, u, f)), 1 === e ? (s(c, {transition: "none", opacity: 1}), c.offsetWidth, setTimeout((function () {
                    s(c, {transition: "all " + u + "ms linear", opacity: 0}), setTimeout((function () {
                        n.remove(), t()
                    }), u)
                }), u)) : setTimeout(t, u)
            })), this
            ...
            }), r.showSpinner || (o = t.querySelector(r.spinnerSelector)) && d(o), u != document.body && l(u, "nprogress-custom-parent"), u.appendChild(t), t
        }, n.remove = function () {
    ...
    window, e.exports = function (e) {
        ...
        !function (t, n) {
            ...
            "use strict";
            var i = [], a = n.document, s = Object.getPrototypeOf, c = i.slice, l = i.concat, u = i.push, f = i.indexOf,
                d = {}, p = d.toString, h = d.hasOwnProperty, m = h.toString, g = m.call(Object), v = {},
                y = function (e) {
                    return "function" == typeof e && "number" != typeof e.nodeType
                }, b = function (e) {
                    return null != e && e === e.window
            ...
            var E = function (e) {
                var t, n, r, o, i, a, s, c, l, u, f, d, p, h, m, g, v, y, b, x = "sizzle" + 1 * new Date,
                    w = e.document, T = 0, C = 0, k = ce(), S = ce(), E = ce(), j = ce(), A = function (e, t) {
                        return e === t && (f = !0), 0
                    }, N = {}.hasOwnProperty, D = [], _ = D.pop, L = D.push, O = D.push, q = D.slice, I = function (e, t) {
                        for (var n = 0, r = e.length; n < r; n++) if (e[n] === t) return n;
                        return -1
                ...
                return ye.prototype = r.filters = r.pseudos, r.setFilters = new ye, a = se.tokenize = function (e, t) {
                    ...
                    if (!s) {
                        ...
                        (s = E(e, function (e, t) {
                            var n = t.length > 0, o = e.length > 0, i = function (i, a, s, c, u) {
                                var f, h, g, v = 0, y = "0", b = i && [], x = [], w = l,
                                    C = i || o && r.find.TAG("*", u), k = T += null == w ? 1 : Math.random() || .1,
                                    S = C.length;
                                for (u && (l = a === p || a || u); y !== S && null != (f = C[y]); y++) {
                                    if (o && f) {
                                        for (h = 0, a || f.ownerDocument === p || (d(f), s = !m); g = e[h++];) if (g(f, a || p, s)) {
            ...
            C.find = E, (C.expr = E.selectors)[":"] = C.expr.pseudos, C.uniqueSort = C.unique = E.uniqueSort, C.text = E.getText, C.isXMLDoc = E.isXML, C.contains = E.contains, C.escapeSelector = E.escape;
            var j = function (e, t, n) {
                for (var r = [], o = void 0 !== n; (e = e[t]) && 9 !== e.nodeType;) if (1 === e.nodeType) {
                    if (o && C(e).is(n)) break;
                    r.push(e)
            ...
            var z = function e(t, n, r, o, i, a, s) {
                var c = 0, l = t.length, u = null == r;
                if ("object" === T(r)) for (c in i = !0, r) e(t, n, c, r[c], !0, a, s); else if (void 0 !== o && (i = !0, y(o) || (s = !0), u && (s ? (n.call(t, o), n = null) : (u = n, n = function (e, t, n) {
                        return u.call(C(e), n)
                    })), n)) for (; c < l; c++) n(t[c], r, s ? o : o.call(t[c], c, n(t[c], r)));
                return i ? t : u ? n.call(t) : l ? n(t[0], r) : a
            }, V = /^-ms-/, X = /-([a-z])/g;
            ...
            C.extend({
                ...
                queue: function (e, t, n) {
                    ...
                    var n = C.queue(e, t = t || "fx"), r = n.length, o = n.shift(), i = C._queueHooks(e, t);
                    "inprogress" === o && (o = n.shift(), r--), o && ("fx" === t && n.unshift("inprogress"), delete i.stop, o.call(e, (function () {
                        C.dequeue(e, t)
                    }), i)), !r && i && i.empty.fire()
                }, _queueHooks: function (e, t) {
            ...
            function Ke(e) {
                return C.cssProps[e] || Qe[e] || (e in Ye ? e : Qe[e] = function (e) {
                    for (var t = e[0].toUpperCase() + e.slice(1), n = Ge.length; n--;) if ((e = Ge[n] + t) in Ye) return e
                }(e) || e)
            }
            ...
            function it(e, t, n) {
                var r = ze(e), o = (!v.boxSizingReliable() || n) && "border-box" === C.css(e, "boxSizing", !1, r),
            ...
            var qt = /%20/g, It = /#.*$/, Ht = /([?&])_=[^&]*/, Pt = /^(.*?):[ \t]*([^\r\n]*)$/gm,
                Mt = /^(?:GET|HEAD)$/, Rt = /^\/\//, Bt = {}, $t = {}, Ft = "*/".concat("*"), Wt = a.createElement("a");
            ...
            Wt.href = Et.href, C.extend({
                ...
                ajax: function (e, t) {
                    ...
                    var r, o, i, s, c, l, u, f, d, p, h = C.ajaxSetup({}, t = t || {}), m = h.context || h,
                        g = h.context && (m.nodeType || m.jquery) ? C(m) : C.event, v = C.Deferred(),
                        y = C.Callbacks("once memory"), b = h.statusCode || {}, x = {}, w = {}, T = "canceled", k = {
                            readyState: 0, getResponseHeader: function (e) {
                                var t;
        ...
        var i = (r(e.i, o, {insert: "head", singleton: !1}), o.locals ? o.locals : {});
        e.exports = i
    }, function (e, t, n) {
        "use strict";
        var r, o = function () {
        ...
        function h(e, t) {
            ...
            if (t.singleton) {
                var i = p++;
                n = d || (d = s(t)), r = u.bind(null, n, i, !1), o = u.bind(null, n, i, !0)
        ...
        "use strict";
        n.r(t);
        var r = n(0), o = n.n(r), i = function (e) {
            alert(e)
        }, a = function () {
            var e = function (e) {
            ...
            Vditor.highlightRender({
                ...
                style: e.hljsStyle
            }, document), Vditor.codeRender(document.body, e.lang), Vditor.mathRender(document.body), Vditor.abcRender(), Vditor.chartRender(), Vditor.mediaRender(document.body), Vditor.mermaidRender(document.body), document.querySelectorAll(".vditor-reset").forEach((function (t) {
            ...
            document.getElementById(e.id).innerHTML = '<div class="vcomment__center"><svg style="height: 260px;width: 260px;background: none;" width="260px"  height="260px"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid"><circle cx="50" cy="50" ng-attr-r="{{config.radius}}" ng-attr-stroke-width="{{config.width}}" ng-attr-stroke="{{config.c1}}" ng-attr-stroke-dasharray="{{config.dasharray}}" fill="none" stroke-linecap="round" r="20" stroke-width="4" stroke="#3b3e43" stroke-dasharray="31.41592653589793 31.41592653589793" transform="rotate(111.924 50 50)"><animateTransform attributeName="transform" type="rotate" calcMode="linear" values="0 50 50;360 50 50" keyTimes="0;1" dur="1.5s" begin="0s" repeatCount="indefinite"></animateTransform></circle><circle cx="50" cy="50" ng-attr-r="{{config.radius2}}" ng-attr-stroke-width="{{config.width}}" ng-attr-stroke="{{config.c2}}" ng-attr-stroke-dasharray="{{config.dasharray2}}" ng-attr-stroke-dashoffset="{{config.dashoffset2}}" fill="none" stroke-linecap="round" r="15" stroke-width="4" stroke="#d23f31" stroke-dasharray="23.561944901923447 23.561944901923447" stroke-dashoffset="23.561944901923447" transform="rotate(-111.924 50 50)"><animateTransform attributeName="transform" type="rotate" calcMode="linear" values="0 50 50;-360 50 50" keyTimes="0;1" dur="1.5s" begin="0s" repeatCount="indefinite"></animateTransform></circle></svg></div>', o.a.ajax({
                ...
                success: function (t) {
                    ...
                    }(e), e.commentVditor = null, 1 !== e.currentPage && o()("html, body").animate({scrollTop: o()("#" + e.id).offset().top}, 300)) : e.error && e.error()
                },
                url: e.url + "/apis/vcomment?aid=" + e.postId + "&p=" + e.currentPage + "&un=" + e.userName
            })
        }, f = function (e, t) {
            if ("disabled" !== t.attr("disabled")) if (t.data("haspermission")) {
                ...
                var c = e.url + "/apis/vcomment/vcomment", l = "POST", f = r.data("commentId");
                f && (c = e.url + "/apis/vcomment/" + f, l = "PUT"), o.a.ajax({
                    cache: !1,
                    data: encodeURIComponent(JSON.stringify(n)),
                    headers: {"X-B3-UA": "vcomment", csrfToken: o()("#" + e.id + " .vcomment").data("csrf")},
                    type: l,
                    url: c,
                    beforeSend: function () {
                    ...
                    success: function (t) {
                        if (0 === t.code) {
                            f ? (document.getElementById(f).outerHTML = t.data.html, a(), s(e.vditor), d(e)) : u(e);
            ...
            if (o()("#" + e.id + " .vcomment").data("login")) {
                var u = o()(".vcomment__editor"), p = o()(".vcomment__editor-main");
                if (o()("#" + e.id + " .vcomment").data("grant")) if ("block" !== u.css("display")) {
                    ...
                    h.removeData(), n ? h.data("commentOriginalCommentId", t).html('<div class="vcomment__meta vcomment__flexinline">\n  <svg class="vcomment__svg" viewBox="0 0 32 32">\n    <path d="M19.583 9.75q-8.667 1.25-13.375 6.625t-6.208 12.958q6.417-9.083 19.583-9.083v7.25l12.417-12.417-12.417-12.417v7.083z"></path>\n  </svg>\n  <span class="vcomment__space"></span>\n  <img class="vcomment__avatar vcomment__avatar--small" src="' + r + '">\n  <span>' + n + "</span>\n</div>") : t ? h.data("commentId", t).html('<div class="vcomment__meta">编辑</div>') : h.html('<div class="vcomment__flexinline vcomment__meta">\n  <svg class="vcomment__svg" viewBox="0 0 32 32">\n    <path d="M19.583 9.75q-8.667 1.25-13.375 6.625t-6.208 12.958q6.417-9.083 19.583-9.083v7.25l12.417-12.417-12.417-12.417v7.083z"></path>\n  </svg>\n  <span class="vcomment__space"></span>\n  <span>' + o()("title").html() + "</span>\n</div>"), u.show(), p.slideDown((function () {
                        !function (e, t) {
                            ...
                            var n = o()("#commentSubmitBtn"), r = {
                                after: function () {
                                    if (t) e.commentVditor.setValue(t), e.commentVditor.focus(); else {
                                        var n = JSON.parse(localStorage.getItem("comments") || "{}");
                                ...
                                preview: {
                                    ...
                                    }, mode: "editor", url: e.url + "/apis/vcomment/markdown", parse: function (t) {
                                        "none" !== t.style.display && (a(), s(e.vditor))
                                    }
                                },
                                resize: {enable: !0, position: "top"},
                                tab: "\t",
                                toolbar: ["emoji", "headings", "bold", "italic", "link", "|", "list", "ordered-list", "check", "|", "quote", "line", "code", "inline-code", "|", "record", "table", "|", "undo", "redo", "|", "wysiwyg", "both", "preview", "format", "|", "fullscreen", "devtools", "info", "help"],
                                typewriterMode: !1
                            };
                            o()(window).width() < 768 && (r.toolbar = ["emoji", "bold", "italic", "link", "list", "check", "wysiwyg", "preview", "fullscreen", "help"], r.resize.enable = !1), e.commentVditor = new Vditor("vcommentVditor", r), n.click((function () {
                                f(e, n)
                            }))
                        }(e, c)
                    }));
                    var m = o()("#" + t);
                    1 === m.length && (o()(window).width() < 768 ? o()(window).scrollTop(m[0].offsetTop - 308) : o()(window).scrollTop(m[0].offsetTop)), m.css({"background-color": "#9bbee0"}), setTimeout((function () {
                        m.css({"background-color": "#FFF", transition: "all 3s cubic-bezier(0.56, -0.36, 0.58, 1)"})
            ...
            function e(e) {
                this.options = function (e) {
                    var t = {
                        ...
                        userName: "",
                        vditor: {emoji: null, hljsEnable: !0, hljsStyle: "github", lang: "zh_CN", lineNumber: !1}
                    };
                    ...
                    o()("#" + e.id).on("click", ".commentCloseBtn", (function () {
                        ...
                        !function (e, t, n, r) {
                            "disabled" !== n.attr("disabled") && o.a.ajax({
                                data: JSON.stringify({commentId: e}),
                                headers: {
                                    "X-B3-UA": "vcomment",
                        ...
                        var t = o()(this), n = t.closest("li").find(".commentActionPanel");
                        !function (e, t, n, r) {
                            "disabled" !== n.attr("disabled") && o.a.ajax({
                                data: JSON.stringify({commentId: e}),
                                headers: {
                        ...
                        var e = o()(this), t = 1 === e.closest(".commentOriginal").length,
                        ...
                        if ("disabled" !== t.attr("disabled")) {
                            ...
                            var n = "POST", r = "", s = JSON.stringify({
                                comment2Content: t.prev().val(),
                                commentId: t.closest("li").attr("id")
                            });
                            t.prev().data("id") && (n = "PUT", r = "/" + t.prev().data("id"), s = JSON.stringify({comment2Content: t.prev().val()})), o.a.ajax({
                                complete: function () {
                    ...
                    o()("#" + e.id).on("click", ".commentMenuBtn", (function () {
                        ...
                        c(t.data("tip"), (function () {
                            "disabled" !== t.attr("disabled") && (t.attr("disabled", "disabled"), o.a.ajax({
                                ...
                                data: JSON.stringify({commentId: t.closest("li").attr("id")}),
                                headers: {
                                    "X-B3-UA": "vcomment",
                                    csrfToken: o()("#" + e.id + " .vcomment").data("csrf")
                                },
                        ...
                        var t = o()(this);
                        d(e, t.closest("li").attr("id"), t.data("name"), t.data("avatar"))
                        ...
                        o.a.ajax({
                            ...
                            success: function (n) {
                                0 === n.code && d(e, t.closest("li").attr("id"), "", "", n.data.commentContent)
                            }
                        })
                        ...
                        c(t.data("tip"), (function () {
                            t.attr("disabled", "disabled"), o.a.ajax({
                                ...
                                data: JSON.stringify({comment2Id: t.closest(".comment2Item").data("id")}),
                                headers: {
                                    "X-B3-UA": "vcomment",
                                    csrfToken: o()("#" + e.id + " .vcomment").data("csrf")
                                },
                        ...
                        var e = o()(this), n = e.closest(".comment2Item");
                    ...
                    d(e)
                })), o.a.ajaxSetup({xhrFields: {withCredentials: !0}})
            }
    ...
    window, e.exports = function (e) {
        ...
        var r = function (e, t, n) {
            return new Promise((function (r, o) {
                fetch(e, {body: JSON.stringify(t), cache: "no-cache", method: "POST"}).then((function (e) {
                    return e.json()
                })).then((function (e) {
                    return r(e)
                })), n && setTimeout((function () {
            ...
            return document.querySelectorAll("[data-" + e + "]").forEach((function (o) {
                ...
                r.push(((i = {count: a})[n] = o.getAttribute("data-" + e).toLowerCase(), i));
            ...
            function e(e) {
                this.options = function (e) {
                    var t = {
                        ...
                        location: {hash: !1, pathname: !0, search: !1},
            ...
            return e.prototype.getStat = function (e, t) {
                return void 0 === t && (t = 0), s(this, void 0, void 0, (function () {
                    return c(this, (function (n) {
                        switch (n.label) {
                            case 0:
                                return [4, r(this.options.url + "/get", {data: e}, t)];
                            case 1:
                ...
                return void 0 === t && (t = 0), s(this, void 0, void 0, (function () {
                    return c(this, (function (n) {
                        switch (n.label) {
                            case 0:
                                return [4, r(this.options.cmtAPI, {data: e}, t)];
                            case 1:
                                return [2, n.sent().data]
                        }
                    }))
    ...
    "use strict";
    n.r(t);
    var r = n(0), o = n.n(r), i = n(1), a = n.n(i), s = n(3), c = n.n(s), l = {
        support: {
            ...
            return {data: t + "_data", time: t + "_time", title: t + "_title"}
        }, removeAllCache: function () {
            if (l.support.storage) for (var e in localStorage) "pjax" === (e.split("_") || [""])[0] && delete localStorage[e]
        ...
        o()("body").delegate(e.selector, "click", (function (t) {
            ...
            if (l.getRealUrl(n) == l.getRealUrl(location.href)) {
                ...
                return r && (location.hash = r, e.callback && e.callback.call(this, {type: "hash"})), !0
            }
            t.preventDefault(), e = o.a.extend(!0, e, {url: n, element: this, push: !0}), u.request(e)
        }))
    };
    u.xhr = null, u.options = {}, u.state = {}, u.defaultOptions = {
        ...
        error: function () {
            u.options.callback && u.options.callback.call(u.options.element, {type: "error"}), location.href = u.options.url
        },
        complete: function (e) {
        ...
        if (!0 !== t && (t = !1), u.html && (e = o()(e).find(u.html).html()), -1 != (e || "").indexOf("<html")) return u.options.callback && u.options.callback.call(u.options.element, {type: "error"}), location.href = u.options.url, !1;
        ...
        "" != s && (u.state.url = u.options.url + (/\?/.test(u.options.url) ? "&" : "?") + s), u.options.push ? (u.active || (history.replaceState(o.a.extend({}, u.state, {
            ...
            u.options.callback && u.options.callback.call(u.options.element, {type: t ? "cache" : "success"})
    ...
    var f = "state" in window.history, d = location.href;
    o()(window).bind("popstate", (function (e) {
        var t = !f && location.href == d;
        if (f = !0, !t) {
            var n = e.state;
    ...
    var p = u, h = n(2), m = n.n(h);
    window.$ = o.a, window.Vcomment = m.a, window.Util = {
        uvstat: void 0, initViewCnt: function (e) {
            ...
            1 === o()("#pjax").length && (p({
                ...
                callback: function () {
                    Util.parseMarkdown(), Util.uvstat.addStat(), Util.uvstat.renderStat(), Util.uvstat.renderCmtStat(window.utilOptions && window.utilOptions.cmtCountCB), e && e()
                }
            }), a.a.configure({showSpinner: !1}), o()("#pjax").bind("pjax.start", (function () {
                a.a.start()
            ...
            o()("body").on("click", ".vditor-reset img", (function () {
                if(o()(this).hasClass("prevent")){
                    return
                }
                var url = o()(this).parents('.vditor-reset').siblings('header').find('a').attr('href');
            ...
            o()("html, body").animate({scrollTop: 0}, 800)
        }, goBottom: function (e) {
            e || (e = 0), o()("html, body").animate({scrollTop: o()(document).height() - o()(window).height() - e}, 800)
        }, init: function (e) {
            Util.killIE(), Util.parseMarkdown(), Util.initSW(), Util.previewImg(), Util.initDebugInfo(), Util.initViewCnt(e && e.cmtCountCB)
        }, initDebugInfo: function () {
            console.log("%cYMFED%c\n  🎸一款小而美的博客系统，专为程序员设计。" + "\n  Copyright © 亚美前端", "font-size:96px;color:#3b3e43", "font-size:12px;color:#4285f4;")
        }, initSW: function () {
            navigator.serviceWorker && navigator.serviceWorker.register("/sw.js", {scope: "/"})
        }, buildTags: function (e) {
            e = e || "tags";
            for (var t = ["tags1", "tags2", "tags3", "tags4", "tags5"], n = o()("#" + e + " b").get(), r = parseInt(o()("#" + e + " b").last().text()), i = Math.ceil(r / t.length), a = 0; a < n.length; a++) for (var s = parseInt(n[a].innerHTML), c = 0; c < t.length; c++) if (s > c * i && s <= (c + 1) * i) {
                n[a].parentNode.className = t[c];
                break
            }
            o()("#" + e).html(o()("#" + e + " li").get().sort((function (e, t) {
                var n = o()(e).find("span").text().toLowerCase(), r = o()(t).find("span").text().toLowerCase();
            ...
            o.a.ajax({
                ...
                cache: !0,
                success: function () {
                    Util.init(window.utilOptions), e && e()
                }
            })
        }
    }, "undefined" == typeof Vditor && Util.loadVditor()
}, , function (e, t, n) {
    "use strict";
    n.r(t);
    n(4);
    window.Skin = {
        _initCommon: function (e) {
            var t = $("header .banner"), n = $("header .navbar");
            $(window).scroll((function () {
                if ($(window).scrollTop() > 125 ? e.show() : e.hide(), $(window).width() < 701) return !1;
                $(window).scrollTop() > t.height() ? (n.addClass("pin"), $(".main-wrap").parent().css("margin-top", "81px"), $(".article__toc").css("position", "fixed")) : (n.removeClass("pin"), $(".main-wrap").parent().css("margin-top", "0"), $(".article__toc").css("position", "inherit"))
            })), $(window).scroll()
        }, init: function () {
            this._initCommon($(".icon-up")), $(".navbar nav a").each((function () {
                this.href === location.href && (this.className = "current")
            })), $(".responsive .list a").each((function () {
                this.href === location.href && $(this).parent().addClass("current")
            ...
            e.css({width: e.parent().width(), left: e.parent().offset().left}).find("a").click((function () {
                e.find("li").removeClass("toc--current"), $(this).parent().addClass("toc--current");
                var t = $(this).attr("href");
                setTimeout((function () {
                    $(window).scrollTop($(t).offset().top - 60)
                }))
            }))
        }
...
$("img").one("error", function(e){
    // $("img").attr("referrerpolicy","origin");
